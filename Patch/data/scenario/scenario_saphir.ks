...
[tb_start_text mode=1 ]
#德比伦
[font size=50]本大爷才不认识你这家伙呢[resetfont][p]
...
[tb_start_text mode=1 ]
#德比伦
[font face="DZUYOKU"][font size=75][emb exp="f.name"]！[r]快把这家伙解决掉！[p]
...
[tb_start_text mode=1 ]
#德比伦
啊？他不是伙伴[r]只是个使魔、[wait time=300]仆人而已！[p]
...
[tb_start_text mode=1 ]
#德比伦
是吗？真令人高兴啊。[wait time=900][chara_mod  name="コマでび"  time="0"  cross="false"  storage="chara/10/10.png"  ][keyframe name="fuwakoma"][frame p="0%" y="-10"][frame p="50%" y="0"][frame p="100%" y="-1"][endkeyframe][kanim name="コマでび" keyframe="fuwakoma" count="infinite" time="400" direction="alternate" easing="linear"][playse  volume="100"  time="0"  buf="1"  storage="sasu.ogg"  ]你以为[r]那匹马会因此兴奋吗！？[p]
[_tb_end_text]

[chara_mod  name="コマでび"  time="0"  cross="false"  storage="chara/10/84.png"  ]
[tb_start_text mode=1 ]
#德比伦
聊着就明白了吧！那家伙可不是那么简单的[r]就对着那匹马骂几句吧！[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
唔咕咕，今天早上才买的啊…[r]本来想着骂他一顿，结果连机会都没有…[p]
...
[tb_start_text mode=1 ]
#萨菲尔
对了，恶魔君。你能不能给我展示一下[r]你擅长的“辱骂”呢？[p]
...
[tb_start_text mode=1 ]
#萨菲尔
啊，我可是没有缺点的哦。[r]所以我希望你能从你的角度来给我指出来[p]
[_tb_end_text]

[chara_mod  name="コマでび"  time="0"  cross="false"  storage="chara/10/91.png"  ]
[tb_start_text mode=1 ]
#德比伦
说、[wait time=300]说些什么好呢？[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#萨菲尔
魔力被夺走，突然感到疲惫不已…[r]啊啊…疲惫的我也依然美丽…[p]
...
[tb_start_text mode=1 ]
#德比伦
[delay speed=200]・・・[resetdelay]你这家伙倒是回应一下啊[r]本大爷好不容易想逗逗你这家伙，却没啥效果[p]
[_tb_end_text]

[chara_mod  name="でびるん"  time="0"  cross="false"  storage="chara/1/10.png"  ]
[tb_start_text mode=4 ]
#德比伦
啊！[wait time=300]难不成是因为刚才说的是真的，[r]所以你这家伙才一点反应都没有吗？
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
不错不错♪ 使魔[r]…不，越来越像个仆人了嘛[p]
[_tb_end_text]

[camera  time="1000"  zoom="1.5"  wait="false"  x="0"  y="50"  rotate="0"  layer="0"  ease_type="ease"  ]
[tb_start_text mode=1 ]
#德比伦
乖孩子，呵呵[r]这一辈子都跟着本大爷吧[p]
...
[tb_start_text mode=1 ]
#德比伦
[font face="DZUYOKU"][font size=75]给点反应啊！！！！[resetfont][p]
[_tb_end_text]
