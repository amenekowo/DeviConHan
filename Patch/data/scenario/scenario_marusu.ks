...
[tb_start_text mode=1 ]
#德比伦
所以啊。为什么不去呢？[r]宅在家里的[if exp="f.syo == 1"][else]召唤师[endif][emb exp="f.name"][p]
...
[tb_start_text mode=1 ]
#玛耳斯
[font face="DZUYOKU"][font size=50][font size=50]恶魔！[r][font size=70][if exp="f.marusu_tenshi == 1]继天使之后是恶魔吗！[else]那、那不是恶魔吗[endif]！[resetfont][p]
...
[tb_start_text mode=1 ]
#德比伦
你这反应也太慢了吧[delay speed=100]・・・[if exp="f.marusu_tenshi == 1][resetdelay]天使是怎么回事[else]还好意思说呀[endif]！[resetfont][p]

[_tb_end_text]

[tb_start_text mode=1 ]
#玛耳斯
竟然和恶魔签订契约[delay speed=300]・・・[resetdelay][p]
...
[tb_start_text mode=1 ]
#玛耳斯
呜呜…这难道是噩梦吗…[r]没想到[emb exp="f.name"][if exp="f.seibetu == 1]君[else]桑[endif]居然和恶魔签订了契约[p]
...
[tb_start_text mode=1 ]
#德比伦
[font size=50]是精灵啊！[resetfont][r]虽然经常被误认为恶魔…但我是精灵啊。[p]

[_tb_end_text]

[tb_start_text mode=1 ]
#德比伦
为、为什么就认定是恶魔呢ー本大爷和[r][emb exp="f.name"]可是有牢固的友情的啊ー[p]
...
[tb_start_text mode=1 ]
#玛耳斯
是、是这样吗！？只是因为长了漂亮的角[r]完全是先入为主地误解了・・・[p]
...
[tb_start_text mode=1 ]
#玛耳斯
很抱歉把[r]作为[emb exp="f.name"][if exp="f.seibetu == 1]君[else]桑[endif]的重要伙伴的精灵君称作恶魔！[p]
...
[tb_start_text mode=1 ]
#玛耳斯
我竟然做出这种无礼的事[r]你这次真的不会再来学校露面了吧[p]
...
[tb_start_text mode=1 ]
#德比伦
[font size=50]本大爷也要去吗！[r][font size=25]哎呦——学校什么的真麻烦・・・[resetfont][p]
...
[tb_start_text mode=1 ]
#玛耳斯
如果[emb exp="f.name"][if exp="f.seibetu == 1]君[else]桑[endif]不愿意，我不会强求的。[r]有兴趣的时候再来就好。还有，把你的伙伴精灵君也一起带来…[p]
...
[tb_start_text mode=1 ]
#德比伦
[font size=25]哎呦——学校什么的麻烦[delay speed=300]・・・[resetdelay][wait time=300][r][font size=50]要，要去的话就勉强去看看吧—[resetfont][p]
...
[tb_start_text mode=1 ]
#玛耳斯
[font size=50]诶诶…！真的吗！[r]你会来吗！？[resetfont][p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#玛耳斯
[font size=50]那真是[delay speed=100]・・・[resetdelay]太好了啊[delay speed=100]・・・[resetdelay][r]嘿嘿嘿[delay speed=100]・・・[resetdelay]呵呵[delay speed=100]・・・[resetdelay][p]
[_tb_end_text]
