...
[tb_start_text mode=1 ]
#库皮亚多艾鲁
[font size=50]德比君是我的哦—！[resetfont][p]
[_tb_end_text]

[tb_start_text mode=1 ]
#德比伦
等、怎么了，多艾鲁！？[r]别拉那么用力[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
[delay speed=100]・・・[resetdelay]难不成[if exp="!f.name"]你这家伙[else][emb exp="f.name"][endif]也[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
总之怎么说呢[delay speed=100]・・・[resetdelay][r]你们这些家伙也太喜欢本大爷了吧♥[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
喵嘎？怎么感觉拉伸得特别夸张啊？[r]本大爷要被分成三段了！[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#库皮亚多艾鲁
[font size=50]德比君！[resetfont][r]昨晚过得很愉快呢[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
[font size=50]别突然搭话！[resetfont][r]真是的，好不容易做了个好梦[p]
[_tb_end_text]
