...
[tb_ptext_show  x="85"  y="76"  size="33"  color="0xffffff"  time="100"  anim="false"  face="craftmincho"  text="首先就让你见识一下<br>本大爷的恶魔之力吧。<br>总之，先召唤试试看！"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[jump  storage="syoukan.ks"  target="*text_end"  ]
*123

[eval exp="f.tips=f.tips||0"]

[tb_ptext_show  x="92"  y="76"  size="33"  color="0xffffff"  time="100"  anim="false"  face="craftmincho"  text="&tf.tipsList[f.tips++%tf.tipsList.length]"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[jump  storage="syoukan.ks"  target="*text_end"  ]
*back_from_kupya
...
[call  target="*item_glink"  storage=""  ]
[call  target="*item_image"  storage=""  ]
[tb_ptext_show  x="83"  y="120"  size="33"  color="0xffffff"  time="100"  anim="false"  face="craftmincho"  text="事情办完了吗？<br>别老让本大爷等着啊"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[image name="menu_kari" layer="0" folder="image" storage="menu_syoukan.png" x="784" y="809" width="496" height="151" cond="$('.menu_kari').length==0"]
*text_end
...
[eval exp="f.phrase = '要让我等到什么时候啊。<br>都快困死了・・・'"]
...
[tb_ptext_hide  time="0"  ]
[tb_ptext_show  x="89"  y="117"  size="33"  color="0xffffff"  time="50"  anim="false"  face="craftmincho"  text="不，这真不行・・・<br>换个别的吧"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[wait  time="1500"  ]
[jump  storage="syoukan.ks"  target="*modoru"  ]
*sumi
...
[tb_ptext_hide  time="0"  ]
[tb_ptext_show  x="85"  y="129"  size="33"  color="0xffffff"  time="50"  anim="false"  face="craftmincho"  text="不都已经结束了吗！"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[wait  time="1500"  ]
[jump  storage="syoukan.ks"  target="*modoru"  ]
*confirm
...
[tb_ptext_show  x="85"  y="114"  size="33"  color="0xffffff"  time="50"  anim="false"  face="craftmincho"  text="和这家伙的连接・・・<br>要开始了～？"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[tb_start_tyrano_code]
[preload  storage="./data/image/ui/waku_small_.png"  ]
[glink name="waku_small" font_color="white" target="*go" face="KaiseiDecol-Bold"  text="是的" x="161" y="470" width="352" height="79" size="30" graphic="ui/waku_small.png" enterimg="ui/waku_small_.png" enterse="tap.ogg"]
[glink name="waku_small" font_color="white" target="*modoru" face="KaiseiDecol-Bold"  text="不是" x="161" y="567" width="352" height="79" size="30" graphic="ui/waku_small.png" enterimg="ui/waku_small_.png" enterse="tap.ogg" clickse="suisyou_NG.ogg"]
[_tb_end_tyrano_code]
...
[tb_ptext_hide  time="0"  ]
[bg  time="200"  method="crossfade"  storage="17.webp"  ]
[tb_ptext_show  x="85"  y="129"  size="33"  color="0xffffff"  time="0"  anim="false"  face="craftmincho"  text="再吹那么多次也没效果啦<br>等过一阵再来吧"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[endif]
