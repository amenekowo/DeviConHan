...
[tb_start_text mode=1 ]
#でびるん
えへーオレサマは[font color=0xEC6FC5 bold=true]ベ[resetfont]…[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#タマモ
[font color=0xEC6FC5 bold=true]ベ[resetfont]…？[p]
...
[tb_start_text mode=1 ]
#でびるん
なんだぁオレサマたちを試してんのか？[r]おい[emb exp="f.name"]どっちか選べ！[p]
...
[tb_start_text mode=1 ]
#コハク
左は妖力回復の葉っぱ！[r]右は残念…魔物に変化する葉っぱだも！[p]
...
[tb_start_text mode=1 ]
#でびるん
頭に葉っぱを乗せたら一瞬で[r][if exp="f.kansou1 == 1"][else]魔力が集まって[endif]真の姿になれたらいいのになぁー[p]
[_tb_end_text]

[chara_mod  name="でびるん"  time="0"  cross="false"  storage="chara/1/11.png"  ]
[tb_start_text mode=1 ]
#でびるん
クフフ…想像したらなんだかやる気が出てきたぜ！[r]魔力回収がんばるぞー！[p]
[_tb_end_text]
