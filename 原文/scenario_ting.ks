...
[tb_start_text mode=1 ]
#でびるん
[font size=48]だー、[wait time=200]有識者ぶってんじゃねー！[resetfont][r]うるさいうるさい変なこと吹き込むな！やっちまえー！[p]
...
[tb_start_text mode=1 ]
#でびるん
ぐぬぬ…気を取り直せ[emb exp="f.name"]！[r]まだ逆転の余地はある！[p]
...
[tb_start_text mode=1 ]
#でびるん
ほら！[emb exp="f.name"][r]何か教えてやれよ！[p]
[_tb_end_text]
...
[choice2 text1="魔法学校の担任について" target1="*mahou" text2="近所のおねえさんについて" target2="*onee"]
...
[tb_start_text mode=1 ]
#ティング
き、近所のおねえさんが花を…？[r]そ…そんなことがあったんだね[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#でびるん
[font size=50]バカがよ！[resetfont][r]んなこと興味ねーだろ！[p]
[_tb_end_text]

[chara_mod  name="ティング"  time="0"  cross="false"  storage="chara/9/7.png"  ]
[tb_start_text mode=1 ]
#ティング
で、でも花を贈られるなんて素敵だね。[r]花言葉とか調べてみたら何か意味があるかもしれないよ[p]
[_tb_end_text]

[chara_mod  name="ティング"  time="0"  cross="false"  storage="chara/9/12.png"  ]
[tb_start_text mode=1 ]
#ティング
薬草学の勉強中、鍋に入れる草花の[r]花言葉を調べるのが最近の趣味なんだぁ[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#ティング
あ、でも魔法学校には薬草学以外にも[r]いろんな科目があるんだよね？[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#でびるん
な～んか甘っちょろくないか…？[r]全然魔法使ってねーじゃん！[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#でびるん
[delay speed=200]・・・[resetdelay]あんだよ、[wait time=200]こっち見んな。[p]
...
[tb_start_text mode=1 ]
#でびるん
[font face="DZUYOKU"][font size=50]散れ！[resetfont][p]
...
[tb_start_text mode=1 ]
#でびるん
[font size=50]恐怖だ！恐怖で制圧するのだ！[r]おみゃーならできる！[resetfont][p]
[_tb_end_text]
