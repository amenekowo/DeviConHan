...
[tb_start_text mode=1 ]
#でびるん
だから協力しようつったろ！あんな禁術を使ってくる[r]化け物…ただの魔法で撃退できるわけがねぇ！[p]
...
[tb_start_text mode=1 ]
#でびるん
おみゃーの魔眼を使えば、弱みとか握れるだろ？[r]その後オレサマが邪眼サーチしてやるからよ[p]
...
[tb_start_text mode=1 ]
#でびるん
はぁ、なんでもアリなこのコーナーも、[r]本編がアレだと作戦会議みたいになっちまうな…[p]
...
[tb_start_text mode=1 ]
#クピャドエル
ウフフ、[emb exp="f.name"]さんはきっと[r]この劇場に助けられてると思いますよぅ[p]
[_tb_end_text]

[chara_mod  name="劇場でび"  time="0"  cross="false"  storage="chara/15/dagya7.png"  ]
[tb_start_text mode=1 ]
#でびるん
んま、なんとか撃退してみようじゃねーの。[r]いくぞ！[emb exp="f.name"][p]
