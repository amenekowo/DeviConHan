...
[tb_start_text mode=1 ]
#でびるん
だってよー。なんで行かねぇんだ？[r]ひきこもり[if exp="f.syo == 1"][else]召喚士[endif][emb exp="f.name"][p]
...
[tb_start_text mode=1 ]
#マルス
先日の魔法検定で高得点だった[emb exp="f.name"][if exp="f.seibetu == 1]くん[else]さん[endif]を[r]見てお話したがってる生徒さんがいました[p]
...
[tb_start_text mode=1 ]
#でびるん
ふん、心が読めるっつーのも[r]そんなにいいもんじゃねーぞ[p]
[_tb_end_text]

[chara_mod  name="コマでび"  time="0"  cross="false"  storage="chara/10/165.png"  ]
[tb_start_text mode=1 ]
#でびるん
んま、下等生物の浅い思考なら[r]読み取るのも苦じゃねぇけどなっ[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#マルス
[font face="DZUYOKU"][font size=50][font size=50]悪魔ッ！[r][font size=70][if exp="f.marusu_tenshi == 1]天使の次は悪魔ですか！[else]それ、悪魔じゃないですか[endif]！[resetfont][p]
...
[tb_start_text mode=1 ]
#でびるん
今更か[delay speed=100]・・・[resetdelay][if exp="f.marusu_tenshi == 1]天使って何のことだ[else]それって言うな[endif]！[resetfont][p]

[_tb_end_text]

[tb_start_text mode=1 ]
#マルス
悪魔と契約していらっしゃるなんて[delay speed=300]・・・[resetdelay][p]
...
[tb_start_text mode=1 ]
#マルス
うぅ…これは悪夢でしょうか…[r]まさか[emb exp="f.name"][if exp="f.seibetu == 1]くん[else]さん[endif]が悪魔と契約しているなんて[p]
...
[tb_start_text mode=1 ]
#マルス
教師である僕の情けない姿をお見せしてしまい…[r]お恥ずかしい限りですうぅぅ[p]
...
[tb_start_text mode=1 ]
#でびるん
[font size=50]精霊なんだよ！[resetfont][r]よく悪魔に間違われるけどな…精霊なんだよ。[p]

[_tb_end_text]

[tb_start_text mode=1 ]
#でびるん
な、なんで悪魔って決めつけっかなーオレサマと[r][emb exp="f.name"]は堅い友情で結ばれてんだけどなー[p]
...
[tb_start_text mode=1 ]
#マルス
そ、そうなのですか！？立派なツノが生えていたばかりに[r]先入観で決めつけてしまいました・・・[p]
...
[tb_start_text mode=1 ]
#でびるん
ヤギの血も混じってんだっけかなー[r]決めつけはよくないぜー[p]
...
[tb_start_text mode=1 ]
#マルス
[emb exp="f.name"][if exp="f.seibetu == 1]くん[else]さん[endif]の大切な相棒の[r]精霊くんを悪魔呼ばわりしてしまい申し訳ありませんんん！[p]
...
[tb_start_text mode=1 ]
#マルス
こんな無礼を働いてしまったら、今度こそ学校に[r]顔を出してくれなくなってしまいますよねえぇ[p]
...
[tb_start_text mode=1 ]
#マルス
いっそのこと…相棒の悪魔くんも[r]一緒に来てはいかがでしょうか？[p]
...
[tb_start_text mode=1 ]
#でびるん
[font size=50]オレサマもかーい！[r][font size=25]うへー学校とかだり・・・[resetfont][p]
...
[tb_start_text mode=1 ]
#マルス
[emb exp="f.name"][if exp="f.seibetu == 1]くん[else]さん[endif]が嫌なら強制はしません。[r]気が向いたらでいいんです。相棒の精霊くんもご一緒に…[p]
...
[tb_start_text mode=1 ]
#でびるん
[font size=25]うへー学校とかだる[delay speed=300]・・・[resetdelay][wait time=300][r][font size=50]い、[wait time=300]行ってやってもいいぞー[resetfont][p]
...
[tb_start_text mode=1 ]
#マルス
え[delay speed=200]・・・[resetdelay][p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#マルス
[font size=50]ええぇ…！ほんとですか！[r]来てくださるんですかぁ！？[resetfont][p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#マルス
[font size=50]それは[delay speed=100]・・・[resetdelay]よかったぁ[delay speed=100]・・・[resetdelay][r]ふひひ[delay speed=100]・・・[resetdelay]へへぇ[delay speed=100]・・・[resetdelay][p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#でびるん
んまぁこんな泥酔してりゃ[r]明日になったら忘れてんだろ[p]
気づかれる前にさっさと魔力回収しようぜ！[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#でびるん
…さてはこやつの反応を楽しんでるな？[r]おみゃーも悪よのぅ[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#でびるん
うるせぇなぁこやつ…ったく[r]学校行ってやっから少しは黙らんか[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#でびるん
んま、何を言おうとこんな泥酔してりゃ[r]明日になったら忘れてんだろ[p]
気づかれる前にさっさと魔力回収しようぜ！[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#でびるん
そんなトコ行かなくていいからぁ[r]一生オレサマの魔力回収代行としてぇ…[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#でびるん
えーといや。あ、相棒ッ[r]相棒としてここにいてくれよなッ！[p]
[_tb_end_text]
