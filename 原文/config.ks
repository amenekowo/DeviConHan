...
[iscript]
	...
	bindGuide('bgmvol_0', 'BGMをオフにするよ')
	bindGuide('sevol_0', 'SEをオフにするよ')
	bindGuide('sevol_0', 'SEをオフにするよ')
	bindGuide('ui_off', 'ONにすると日付や魔力ゲージが消えるよ')
	bindGuide('fullscreen', 'ONにするとフルスクリーンになるよ')
	bindGuide('light', 'ONにするとエフェクトが軽減されるよ')
	bindGuide('censorshipMode', 'ONにすると一部の文字が隠されるよ')
[endscript]
