...
[tb_start_tyrano_code]
[glink name="waku_small" font_color="white" face="KaiseiDecol-Bold" target="*load" text="ロードする" cm="false" x="264" y="760" width="352" height="79" size="30" graphic="ui/waku_small2.png" enterimg="ui/waku_small_.png" enterse="tap.ogg" clickse="OK.ogg"]
[glink name="waku_small" font_color="white" face="KaiseiDecol-Bold" target="*title" text="タイトルへ戻る" x="664" y="760" width="352" height="79" size="30" graphic="ui/waku_small2.png" enterimg="ui/waku_small_.png" enterse="tap.ogg" clickse="OK.ogg"]
[_tb_end_tyrano_code]
