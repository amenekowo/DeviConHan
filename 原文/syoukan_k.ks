...
[tb_ptext_show  name="syoukan_devi_phrase"  x="85"  y="114"  size="33"  color="0xffffff"  time="100"  anim="false"  face="craftmincho"  text="どこ行ってたんだおみゃー<br>あまりオレサマを待たせるなよ"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[endif]
...
[call  target="*item_glink"  storage=""  ]
[call  target="*item_image"  storage=""  ]
[tb_ptext_show  name="syoukan_devi_phrase"  x="88"  y="114"  size="33"  color="0xffffff"  time="100"  anim="false"  face="craftmincho"  text="用は済んだか？<br>あまりオレサマを待たせるなよ"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[image name="menu_kari" layer="0" folder="image" storage="menu_syoukan.png" x="784" y="809" width="496" height="151" cond="$('.menu_kari').length==0"]
*text_end
...
[eval exp="f.phrase = '酒が回ってきたな…<br>早く…選べよ…'"]
...
tf.mimiPhases = [
{
phrase: 'やめろ！今は邪眼<br>以外も敏感なんだよ！',
bg: 'k_mimi'
},
{
phrase: 'てみゃー！<br>話聞いてんのか！？',
bg: 'k_mimi'
},
{
phrase: 'くそっ…<br>ぜってー反応してやんねーから',
bg: 'k_mimi2'
},
{
phrase: '・・・',
...
{
phrase: 'おい！オレサマの<br>話を聞いているのか！？',
bg: 'k_tuno'
},
{
phrase: 'あっあぎゃ、今は感覚が<br>研ぎ澄まされてるから！',
bg: 'k_tuno2'
},
{
phrase: 'しつこいぞ！<br>てみゃあー！',
bg: 'k_tuno2'
},
{
phrase: '旗に触れてから触られると<br>特にダメだ！',
bg: 'k_tuno2'
},
{
phrase: 'さてはオレサマの反応を<br>楽しんでるだろ！？',
bg: 'k_tuno3'
},
{
phrase: 'くそっ、ぜってー<br>反応してやんねぇからな',
bg: 'k_tuno3'
},
{
phrase: '・・・',
...
tf.atamaPhases = [
{
phrase: '…なでられるのは<br>見下されてるみたいで<br>大嫌いなんだよ！',
bg: 'k_atama'
},
{
phrase: '・・・',
...
[quake  time="300"  count="5"  hmax="3"  wait="false"  ]
[tb_ptext_hide  time="0"  ]
[tb_ptext_show  x="85"  y="129"  size="33"  color="0xffffff"  time="0"  anim="false"  face="craftmincho"  text="ハッ…寝てねーぞ"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[flash_off  time="0"  effect="fadeOut"  ]
...
[tb_ptext_hide  time="0"  ]
[tb_ptext_show  x="84"  y="119"  size="33"  color="0xffffff"  time="50"  anim="false"  face="craftmincho"  text="ムリってわかるだろ<br>他のにしろ"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[wait  time="1500"  ]
[jump  storage="syoukan_k.ks"  target="*modoru"  ]
*sumi
...
[tb_ptext_hide  time="0"  ]
[tb_ptext_show  x="85"  y="129"  size="33"  color="0xffffff"  time="50"  anim="false"  face="craftmincho"  text="もう終わったろ"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[wait  time="1500"  ]
[jump  storage="syoukan_k.ks"  target="*modoru"  ]
*confirm
...
[tb_ptext_show  x="85"  y="114"  size="33"  color="0xffffff"  time="50"  anim="false"  face="craftmincho"  text="こやつから魔力・・・<br>強奪しちまう～？"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[tb_start_tyrano_code]
...
[tb_ptext_show  x="84"  y="115"  size="33"  color="0xffffff"  time="0"  anim="false"  face="craftmincho"  text="かすれてちいせぇ音だな<br>MPがちょっとばかし増えたぜ"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
...
[tb_ptext_hide  time="0"  ]
[bg  time="200"  method="crossfade"  storage="k_no.webp"  ]
[tb_ptext_show  x="83"  y="118"  size="33"  color="0xffffff"  time="0"  anim="false"  face="craftmincho"  text="んな何度も吹いても効果ないぞ<br>時間を置いてからにするんだな"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[endif]
...
[tb_ptext_show  x="89"  y="118"  size="33"  color="0xffffff"  time="0"  anim="false"  face="craftmincho"  text="邪眼が冴えるぜ！<br>やってやろうじゃねーの"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[wait  time="300"  ]
[l  ]
[jump  storage="syoukan_k.ks"  target="*modoru"  ]
*item_glink
