...
[tb_start_text mode=1 ]
#でびるん
[emb exp="f.name"]のやつ…[r]なんで自ら部屋を燃やしちまったんだ？[p]
...
[tb_start_text mode=1 ]
#でびるん
あぁ、あんな気の狂った蛇の魔女に[r]寝返ろうとしたのが悪いんだな[p]
...
[tb_start_text mode=1 ]
#でびるん
ケッ[delay speed=100]・・・[resetdelay]呆れてものも言えねぇぜ[chara_hide  name="劇場でび"  time="1000"  wait="false"  pos_mode="false"  ][r][font size=25]せいぜい自分の首を絞めるんだな[resetfont][p]
[_tb_end_text]

[chara_mod  name="劇場える"  time="0"  cross="false"  storage="chara/16/kupya10.png"  ]
[tb_start_text mode=1 ]
#クピャドエル
・・・[emb exp="f.name"]さん[r]大丈夫ですか？[p]
[_tb_end_text]

[tb_start_text mode=1 ]
#クピャドエル
あの手の呪術魔法はきっといくらロードしようとも[r][emb exp="f.name"]さんの精神を蝕み続けます[p]
[_tb_end_text]

[tb_start_text mode=1 ]
#クピャドエル
[delay speed=100]・・・[resetdelay]やり直しが効くからといって軽率な行動を取ると[r]本当に取り返しのつかないことになりますよ[p]
[_tb_end_text]
