...
[tb_start_text mode=1 ]
#玉藻
真是个少见的地方呢[delay speed=300]・・・[resetdelay][p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
诶嘿—本大爷是[font color=0xEC6FC5 bold=true]贝[resetfont]・・・[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#玉藻
[font color=0xEC6FC5 bold=true]贝[resetfont]・・・？[p]
...
[tb_start_text mode=1 ]
#德比伦
怎么，你在考验本大爷吗？[r]喂，[emb exp="f.name"]选一个吧！[p]
