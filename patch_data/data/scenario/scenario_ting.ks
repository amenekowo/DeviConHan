...
[tb_start_text mode=1 ]
#德比伦
[font size=48]啊ー！[wait time=200]别在那装什么知识分子啦！[resetfont][r]吵死了吵死了，别说些奇奇怪怪的话啦！上啊ー！[p]
...
[tb_start_text mode=1 ]
#德比伦
唔咕咕…打起精神来，[emb exp="f.name"]！[r]还没到逆转无望的时候！[p]
...
[tb_start_text mode=1 ]
#德比伦
喂！[emb exp="f.name"][r]赶紧告诉他点什么啊！[p]
[_tb_end_text]
...
[choice2 text1="关于魔法学校的班主任" target1="*mahou" text2="关于邻家的姐姐" target2="*onee"]
...
[tb_start_text mode=1 ]
#德比伦
[font size=50]你这蠢货！[resetfont][r]那种事谁会感兴趣啊！[p]
[_tb_end_text]

[chara_mod  name="ティング"  time="0"  cross="false"  storage="chara/9/7.png"  ]
[tb_start_text mode=1 ]
#廷格
但、但是被送花听起来还是挺浪漫的呢。[r]要是查查花语的话，说不定能发现什么特别的含义哦。[p]
[_tb_end_text]

[chara_mod  name="ティング"  time="0"  cross="false"  storage="chara/9/12.png"  ]
[tb_start_text mode=1 ]
#廷格
最近的兴趣啊，是在学药草学的时候，顺便查查[r]放进药锅里的那些草花的花语呢～[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#廷格
啊，不过魔法学校里除了药草学[r]也有很多其他课程吧？[p]
[_tb_end_text]

[tb_start_text mode=1 ]
#廷格
要是能告诉我一些我还不知道的魔法学校的事情…[r]我会很开心的～[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
哼哼，你这家伙…果然没让[r]身为大恶魔的本大爷看走眼啊～果然有点料嘛。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
[delay speed=200]・・・[resetdelay]啥啊，[wait time=200]别看这边。[p]
...
[tb_start_text mode=1 ]
#德比伦
[font size=50]恐惧啊！用恐惧来镇压一切！[r]你这家伙一定能做到的！[resetfont][p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
[font size=50]是恐惧！要用恐惧来制服他们！[r]你这家伙一定能做到的！[resetfont][p]
[_tb_end_text]
