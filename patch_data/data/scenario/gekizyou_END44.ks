...
#德比伦
[font size=50]什么叫回窝啊！[resetfont][r]先不管了，竟然命令我做像狗一样的事！[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
[font size=50]都怪你这家伙那恶趣味，害得我这边[r]被当成变态了不是嘛！[resetfont][p]
[_tb_end_text]

[tb_start_text mode=1 ]
#德比伦
[font size=50]好不容易建立起来的[r]本大爷的尊严别给我毁了！[resetfont][p]
[_tb_end_text]
