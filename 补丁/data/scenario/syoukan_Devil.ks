...
[call  target="*item_glink"  storage=""  ]
[call  target="*item_image"  storage=""  ]
[tb_ptext_show  x="83"  y="120"  size="33"  color="0xffffff"  time="100"  anim="false"  face="KaiseiDecol-Bold"  text="辛苦啦<br>找到要找的东西了吗？"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
...
[eval exp="f.phrase = '各位恶魔的气氛<br>真是阴森可怖呢・・・'"]

[elsif exp="f.nemumi == 2"]

[eval exp="f.phrase = '咕啵——总觉得<br>有点坐立不安・・・'"]

[elsif exp="f.nemumi == 3"]

[eval exp="f.phrase = '准备好了的话<br>就开始吧！'"]
...
[tb_ptext_hide  time="0"  ]
[tb_ptext_show  x="89"  y="117"  size="33"  color="0xffffff"  time="50"  anim="false"  face="KaiseiDecol-Bold"  text="看样子还不行呢"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[wait  time="1500"  ]
[jump  storage="syoukan_Devil.ks"  target="*modoru"  ]
*sumi
...
[bg  time="200"  method="crossfade"  storage="kupya_syo1.webp"  ]
[tb_ptext_hide  time="0"  ]
[tb_ptext_show  x="85"  y="129"  size="33"  color="0xffffff"  time="50"  anim="false"  face="KaiseiDecol-Bold"  text="已经召唤完毕啦？"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
[wait  time="1500"  ]
[jump  storage="syoukan_Devil.ks"  target="*modoru"  ]
*confirm
...
[tb_ptext_show  x="85"  y="114"  size="33"  color="0xffffff"  time="50"  anim="false"  face="KaiseiDecol-Bold"  text="那么！连接・・・<br>开始啦～？"  edge="undefined"  shadow="undefined"  fadeout="true"  wait="false"  in_effect="fadeInDown"  out_effect="fadeOutUp"  ]
...
tf.tipsList = [
//0日目
'咕啵啊—♥这个我一直<br>想试一次呢<br>总觉得心跳加速',//ブブ
'作为天使的使命・・・<br>一定要让各位恶魔<br>以更好的方式获得幸福！',//あも
'接下来是传闻中的利维坦桑・・・<br>在下会负责直到<br>完成召唤',//レヴィ
//1日目
'咕啵・・・虽然睡眠不足<br>今天也打起精神<br>上吧！',//マネ
'玛尼猫桑所说的<br>“忙碌中”究竟是<br>什么意思呢',//ドレ
'米迦勒大人・・・<br>请您看着吧',//ハーデスター
//2日目
'1<br>2<br>3！',
]
[endscript]
