...
[choice2 text1="帮忙" color1="0x989898" graphic1="disabled" disabled1="true" text2="不帮忙" target2="*no"]
...
[tb_start_text mode=1 ]
#德比伦
[font size=70]嗯嘛，能有个顺从的使魔在身边，[r]本大爷心情不错，就准了★[resetfont][p]
...
[tb_start_text mode=1 ]
#德比伦
[font size=50]喂！[wait time=300][r]别傻站着看啊，快来扶我一把！[resetfont][p]
...
[tb_start_text mode=1 ]
#德比伦
[font size=50]喂！[r]别光站那儿，快来救本大爷啊！！[resetfont][p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#德比伦
[font size=50]你这家伙也是！[r]别光站那儿，赶紧来救本大爷啊！！[resetfont][p]
[_tb_end_text]
...
[choice2 text1="就那样递过去"  graphic1="disabled" color1="0x989898" disabled1="true"  text2="拿回来" target2="*kaesu" y="500"]
...
[tb_start_text mode=1 ]
#德比伦
在本大爷这等崇拜对象遭遇大麻烦的时候，[r]就该挺身而出保护啊ー！[p]
[_tb_end_text]
