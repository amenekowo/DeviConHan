...
[tb_start_text mode=1 ]
#BBB
[delay speed=100]把你逼到这个地步的[r][ruby text="⠀"]是老夫我啊[wait time=500]，[ruby text="ゆる"]原谅我吧。[resetdelay][p]
...
[tb_start_text mode=1 ]
#BBB
[ruby text="⠀"][delay speed=100]吾之名为[ruby text="ビー"]B[ruby text="ス"]B[ruby text="リー"]B。[wait time=300][r]和这个家伙是类似上司与下属的关系。[resetdelay][p]
...
[tb_start_text mode=1 ]
#BBB
[delay speed=100]我也曾考虑过带他回魔界。[wait time=500][r][ruby text="⠀"]但对这家伙来说，那是极大的[ruby text="くつ"]屈[ruby text="じょく"]辱。[resetdelay][p]
...
[tb_start_text mode=1 ]
#BBB
[delay speed=100]追着贝尔到处跑还说得那么好听，真不愧是个[ruby text="ひ"]卑[ruby text="ぞく"]俗的天使。[resetdelay][p]
...
[tb_start_text mode=1 ]
#BBB
[font size=25][delay speed=100][ruby text="ゆる"]原谅我吧[resetdelay][resetfont][p]
